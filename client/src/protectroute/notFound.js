  ...
  return (
    <Container maxWidth="sm">
      ...
      <Box pb={2} pt={1} fontSize={15} textAlign="center" color="#637381">
        ...
        <Link href='/'>
          <Button  style={{backgroundColor:"#51AC56", color:"white", textTransform:"capitalize", borderRadius:"8px"}}><Box px={1.5} py={0.3} fontWeight={600} color="white">Go To Home</Box></Button>
      </Link>
          </Box>
      <Box
        display="flex"
