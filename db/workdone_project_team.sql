...
CREATE TABLE `project_team` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_project_team_1_idx` (`project_id`),
  KEY `fk_project_team_2_idx` (`user_id`),
  CONSTRAINT `fk_project_team_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`),
  CONSTRAINT `fk_project_team_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
